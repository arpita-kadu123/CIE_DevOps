...
import com.example.myhotel.auth.LoginPage;
import com.example.myhotel.auth.RegisterPage;
import com.example.myhotel.auth.VerifyEmail;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (user != null) {
            ...
            Intent intent;
            if(email.equals("arpitakadu8@gmail.com")){
